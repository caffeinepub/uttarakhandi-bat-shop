...
export class Backend implements backendInterface {
    ...
    async addBat(arg0: string, arg1: string, arg2: string, arg3: bigint): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.addBat(arg0, arg1, arg2, arg3);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async checkout(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getBats(): Promise<Array<Bat>> {
        if (this.processError) {
            try {
                const result = await this.actor.getBats();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async viewCart(): Promise<Array<CartItem>> {
        if (this.processError) {
            try {
